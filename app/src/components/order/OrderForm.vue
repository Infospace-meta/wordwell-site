      ...
      >
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="p-4 border border-orange-200 rounded-lg">
            ...
            <div
              class="flex items-center gap-1.5 bg-orange-50 mt-2 px-3 py-2 border border-orange-200 rounded-md font-medium text-orange-700 text-xs"
            >
              <svg
...
/**Logic for $20 per page (should match backend pricing) */
const standardCost = computed(
  () => SERVICE_COSTS[form.value.service_type] ?? 20,
);
